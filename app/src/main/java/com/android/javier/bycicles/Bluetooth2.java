...
/**
 * Created by reyes on 27/03/2017.
 */
...
public class Bluetooth2 extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        de = (Button) findViewById(R.id.derecha);
            ...
            public void handleMessage(android.os.Message msg) {
                if (msg.what == handlerState) {										//if message is what we want
                   ...
                   //     txtStringLength.setText("Tamaño del String = " + String.valueOf(dataLength));
                     ...
                     //       String sensor1 = recDataString.substring(2, 4);            //same again...
                       //     String sensor2 = recDataString.substring(5, 7);
                         //   String sensor3 = recDataString.substring();
        ...
        switch (requestCode){
            case REQ_CODE_VOZ:
            {
                if(resultCode ==RESULT_OK && null !=data){
                    final ArrayList<String> vozenIntent = data.getStringArrayListExtra(RecognizerIntent.EXTRA_RESULTS);
                    sensorView0.setText(vozenIntent.get(0));
                    new Handler().postDelayed(new Runnable() {
                        @Override
                        public void run() {


                                Toast.makeText(getBaseContext(), vozenIntent.get(0),Toast.LENGTH_SHORT);

                            if (vozenIntent.get(0).equals("1")) {

                                mConnectedThread.write("1");
                            }
                            if (vozenIntent.get(0).equals("2")) {

                                mConnectedThread.write("2");
                            }
                            if (vozenIntent.get(0).equals("3")) {

                                mConnectedThread.write("3");
                            }
                            if (vozenIntent.get(0).equals("4")) {
